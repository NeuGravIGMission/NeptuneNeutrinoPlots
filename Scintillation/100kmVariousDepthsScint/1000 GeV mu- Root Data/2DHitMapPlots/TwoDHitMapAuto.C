...
for(int i =1; i<=10; i++)
  ...
  if(i<10)
    {
      nameFile1 = "mu-+1000+-100+-2" + indexstr + "0";
      nameFile2 = "mu-+1000+0+-2" + indexstr + "0";
      nameFile3 = "mu-+1000+100+-2" + indexstr + "0";
      nameFile4 = "mu-+1000+200+-2" + indexstr + "0";
      nameFile5 = "mu-+1000+-200+-2" + indexstr + "0";
      nameFile = "Muon_1000GeV_"+indexstr+"0kmDepth.png";
    }
  else
    {
      nameFile1 = "mu-+1000+-100+-300";
      nameFile2 = "mu-+1000+0+-300";
      nameFile3 = "mu-+1000+100+-300";
      nameFile4 = "mu-+1000+200+-300";
      nameFile5 = "mu-+1000+-200+-300";
      nameFile = "Muon_1000GeV_100kmDepth.png";
    }
